namespace R25_Database_Editor
{
    partial class About
    {
        ...
        private void InitializeComponent()
        {
            ...
            info_richTextBox.Text = "Description: Edit the original Rugby 25 Default Team and Player Database.\n\nAuthor: Wouldubeinta\nDiscord ID: Wouldubeinta";
            // 
            // license_tabPage
            // 
            ...
            changelog_richTextBox.Text = "-1.0.0.3-\n* Updated the team and player databases from game update v1.0.4016.\n* Made some changers to Player List in Team Editor.\n\n-1.0.0.2-\n* Initial Release";
            ...
            title_label.Size = new Size(250, 28);
            title_label.TabIndex = 3;
            title_label.Text = "R25 Database Editor";
            // 
            // version_label
            // 
